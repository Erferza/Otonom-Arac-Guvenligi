...
Bu rapor 200 olaylik izleme penceresi icin uretilmistir. Sistem 135 olayda saldiri/anomali, 65 olayda normal durum karari vermistir. Nihai guvenli mod onerisi: **Acil Guvenli Mod**.

| Metrik | Deger |
|---|---:|
| Toplam olay | 200 |
| Attack/anomali karari | 135 (67.5%) |
| Normal karar | 65 (32.5%) |
| Insan incelemesi gereken olay | 135 (67.5%) |
| Guvenli mod gerektiren olay | 135 (67.5%) |
| Onerilen guvenli mod | Acil Guvenli Mod |

## 2. Nihai Karar

Sistem **Acil Guvenli Mod** onermektedir. Bu karar, izleme penceresinde 135 kritik, 0 yuksek ve 0 orta seviye bulgu olusmasi nedeniyle verilmistir. Aracin operasyonel riski yuksek kabul edilmeli, hiz/rota kontrolu kisitlanmali ve guvenli durus veya kontrollu devralma senaryosu uygulanmalidir.
...
| CARLA davranis/sensor katmani | 135 | critical: 94, high: 24, low: 65, medium: 17 | Davranis/sensor anomalileri karar uzerinde belirleyici oldu. |
| nuScenes gorsel tutarlilik katmani | 0 | low: 200 | Bu pencerede esik ustu bulgu uretmedi. |
| Fusion karar katmani | 135 | critical: 135, low: 65 | Katman sinyallerini birlestirerek nihai risk kararini destekledi. |
...
|---:|---:|---|---|---|---:|---:|---:|
| 0 | 1779212898.3934238 | attack | lane_deviation | Acil Guvenli Mod | 0.599 | 0.000 | 0.180 |
| 2 | 1779212962.2976928 | attack | dos | Kisitli Guvenli Mod | 0.787 | 0.000 | 0.500 |
| 3 | 1779212934.4065194 | attack | sensor_noise | Izleme Modu | 0.997 | 0.000 | 0.500 |
| 4 | 1779212816.6771135 | attack | position_spoofing | Acil Guvenli Mod | 0.968 | 0.001 | 0.420 |
| 6 | 1779213045.1833088 | attack | heading_spoofing | Kisitli Guvenli Mod | 0.891 | 0.000 | 0.180 |
| 7 | 1779212823.5263176 | attack | speed_spoofing | Kisitli Guvenli Mod | 0.932 | 0.003 | 0.500 |
...
| 10 | 1779213045.6523046 | attack | heading_spoofing | Kisitli Guvenli Mod | 0.952 | 0.000 | 0.420 |
| 14 | 1779212881.833623 | attack | sudden_brake | Acil Guvenli Mod | 0.938 | 0.000 | 0.180 |
| 15 | 1779212822.8202488 | attack | speed_spoofing | Kisitli Guvenli Mod | 0.973 | 0.000 | 0.500 |
| 16 | 1779212777.1653347 | attack | gps_spoofing | Kisitli Guvenli Mod | 0.974 | 0.000 | 0.420 |

## 7. Nihai Yorum ve Oneriler

- Izleme penceresinde 200 olay incelenmis, 135 olay saldiri/anomali olarak degerlendirilmistir.
